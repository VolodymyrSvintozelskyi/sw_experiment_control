...
(function($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        _build: function() {
            ...
            function add_data_par(el_subset, json_subset){
                $.each(json_subset, function(i,val){
                    console.log("Assigning... ", el_subset.children().eq(i), val);
                    el_subset.children().eq(i).data("pars", val["pars"]);
                    if (val["children"]){
                        add_data_par(el_subset.find("ol").eq(0), val["children"]);
                    }
                });
            }
            add_data_par($(this.el).find("ol").eq(0), json);
